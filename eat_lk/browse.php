...
<body class="content">
	...
	<div class="container my-5" id="browse_box">
		<div class="row">
			<div class="col-8">
				<h2 class="display-4 text-light"><i class="fas fa-book-open"></i> Catalogue</h2>
			</div>
			<div class="col-4">
					...
					?>
						...
						<div class="card text-left" style="width: 18rem;">
							...
							<div class="card-footer text-right" id="<?php echo encryptIt($itm_id); ?>">
								<h5 class="card-text float-left text-success">LKR <?php echo number_format($itm_prc, 2); ?></h5>
