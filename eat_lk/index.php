        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                ...
                //    echo '<a href="profile?act=update" class="btn btn-outline-light">Update your info</a>';
                    echo '<a href="profile" class="btn btn-outline-light">View your info</a>';
                    echo '</div>';
                } else {
                    echo '<div class="col-12 text-center text-white">';
                    ...
                    <div class="modal-body mx-3">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <small class="text-muted text-center"> Register as a restaurant <a href="" class="text-primary" data-toggle="modal" data-dismiss="modal" data-target="#modalVendorForm">here</a>.</small>
                            </div>
                        </div>
